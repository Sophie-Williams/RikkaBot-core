...
public class VersionCommand extends Command {
     ...
     * Command ID.
     */
    public static final short ID = 667;
    ...
    /**
     * Compatibility with the bot client version
     */
    public boolean compatible;

    public VersionCommand(int major, int minor, int build) {
        super(VersionCommand.ID);
    ...
    protected void _write(DataOutput output) throws IOException {
        ...
        output.writeBoolean(this.compatible);
    }
    ...
    public void read(DataInput input) throws IOException {
        ...
        this.compatible = input.readBoolean();
    }
}